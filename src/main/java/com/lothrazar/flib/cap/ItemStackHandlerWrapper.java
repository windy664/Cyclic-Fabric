package com.lothrazar.flib.cap;
...
public record ItemStackHandlerWrapper(ItemStackHandler input, ItemStackHandler output) implements SlottedStackStorage, INBTSerializable<CompoundTag> {
     ...
     */
    private void withHandlerV(int slot, HandlerCallbackVoid func) {
