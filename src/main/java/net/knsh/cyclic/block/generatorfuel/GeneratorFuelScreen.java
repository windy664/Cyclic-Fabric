...
public class GeneratorFuelScreen extends ScreenBase<GeneratorFuelContainer> {
    ...
    protected void init() {
        super.init();
        this.energy = new EnergyBar(this.font, GeneratorFuelBlockEntity.MAX);
        ...
        x = leftPos + 6;
        y = topPos + 6;
        btnRedstone = addRenderableWidget(new ButtonMachineField(x, y, GeneratorFuelBlockEntity.Fields.REDSTONE.ordinal(), menu.tile.getBlockPos()));
        x = leftPos + 132;
        y = topPos + 36;
        btnToggle = addRenderableWidget(new ButtonMachine(x, y, 14, 14, "", (p) -> {
            int f = GeneratorFuelBlockEntity.Fields.FLOWING.ordinal();
    ...
    protected void renderLabels(GuiGraphics ms, int mouseX, int mouseY) {
        ...
        int fld = GeneratorFuelBlockEntity.Fields.FLOWING.ordinal();
