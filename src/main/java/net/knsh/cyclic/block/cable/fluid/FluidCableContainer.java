...
public class FluidCableContainer extends ContainerBase {
    protected FluidCableBlockEntity tile;
    private final Container inventory;

    public FluidCableContainer(int syncId, Inventory playerInventory, Level world, BlockPos pos) {
        this(syncId, playerInventory, new SimpleContainer(1), world, pos);
    }

    public FluidCableContainer(int syncId, Inventory playerInventory, Container inventorysent, Level world, BlockPos pos) {
