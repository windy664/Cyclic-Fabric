 ...
 * <br>
 * All children of this event are fired on the {@link net.knsh.cyclic.porting.neoforge.NeoForge#EVENT_BUS}.<br>
 **/
public abstract class EntityEvent extends ForgeEvent {
     ...
     * <br>
     * This event is not {@link net.knsh.cyclic.porting.neoforge.bus.api.ICancellableEvent}.<br>
     * <br>
     * This event does not have a result. {HasResult}<br>
     * <br>
     * This event is fired on the {@link net.knsh.cyclic.porting.neoforge.NeoForge#EVENT_BUS}.<br>
     **/
    ...
    /**
     * This event is fired whenever the {@link net.minecraft.world.entity.Pose} changes, and in a few other hardcoded scenarios.<br>
